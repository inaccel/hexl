...
/// @brief Radix-2 FPGA NTT implementation of the forward NTT (InAccel integr.)
/// @param[out] result Output data. Overwritten with NTT output
/// @param[in] operand Input data.
/// @param[in] n Size of the transform, i.e. the polynomial degree. Must be a
/// power of two.
...
/// @brief Radix-2 FPGA NTT implementation of the inverse NTT (InAccel integr.)
/// @param[out] result Output data. Overwritten with NTT output
/// @param[in] operand Input data.
/// @param[in] n Size of the transform, i.e. the polynomial degree. Must be a
/// power of two.
...
/// @param[in] output_mod_factor Upper bound for result; result must be in [0,
/// output_mod_factor * q)
/// @param[in] inv_n InverseMod of NTT size
/// @param[in] inv_n_w MultiplyMod of inv_n with inv_root_of_unity_powers[n - 1]
/// @param[in] batch Number of batched data on which to compute the inverse NTT
